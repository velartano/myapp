 ...
 */
final class Version20221227142958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('CREATE TABLE bien_immobilier (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR (255) NOT NULL, prix INT NOT NULL, url VARCHAR (255) NOT NULL, code_postal INT NOT NULL, description VARCHAR(200) NOT NULL, localisation VARCHAR(25) NOT NULL, surface VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
