 ...
 */
final class Version20221227145820 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bien_immobilier ADD description VARCHAR(200) NOT NULL, ADD ville VARCHAR(25) NOT NULL, ADD surface VARCHAR(10) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bien_immobilier DROP description, DROP ville, DROP surface');
    }
}
