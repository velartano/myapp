...
final class Version20230104220720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE bien_immobilier CHANGE image image VARCHAR (255) NOT NULL, CHANGE description description VARCHAR(200) NOT NULL, CHANGE ville ville VARCHAR(25) NOT NULL, CHANGE surface surface VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bien_immobilier CHANGE description description VARCHAR(255) DEFAULT NULL, CHANGE ville ville VARCHAR(255) DEFAULT NULL, CHANGE surface surface VARCHAR(255) DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
